      ...
      <div className="relative px-6">
        {images.length > 0 ? (
          <div className="relative">
            <Image
              src={`data:image/jpeg;base64,${images[currentImageIndex]}`} // Display current image based on index
              alt="Property image"
              className="object-cover hover:scale-105 transition-transform duration-300"
              width={600}
              height={600}
            ...
            {images.length > 1 && (
              <div className="mx-10">
                <button
                  ...
                  className="absolute top-1/2 left-5 transform -translate-y-1/2 bg-black/50 text-white p-3 rounded-full "
                >
                  <Image
                ...
                <button
                  ...
                  className="absolute top-1/2 right-5 transform -translate-y-1/2 bg-black/50 text-white p-3   rounded-full "
                >
                  <Image
